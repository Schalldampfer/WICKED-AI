...
//Spawn Crates
local _loot = if (_aiType == "Hero") then {Loot_UralAttack select 0;} else {Loot_UralAttack select 1;};
[[
	[_loot,WAI_CrateMd,[-5,-5]]
...
*/
//Spawn vehicles
local _vehicle = [WAI_CargoTruck,[(_position select 0) +0,(_position select 1) -0, 0],_mission] call WAI_PublishVeh;
