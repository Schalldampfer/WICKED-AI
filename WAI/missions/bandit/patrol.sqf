...
//Armed Land Vehicle
_vehclass = ["HMMWV_M2_DZ","UAZ_MG_TK_EP1_DZE","LandRover_MG_TK_EP1_DZE","Offroad_DSHKM_Gue_DZE"] call BIS_fnc_selectRandom;
...
// Loot
_loot = [[8,(ai_wep_special_good + ai_wep_special_cheap)],4,[2,["ItemBriefcase100oz"]],2,2];
