...
//Spawn Crates
[[
	[[0,6,[6,(crate_items_high_value + crate_items_vehicle_repair)],0,2],crates_small,[.2,0]]
...
],(["UH1Wreck","UH60_wreck_EP1"] call BIS_fnc_selectRandom),"Medium","Bandit","Bandit",0,2,"Random","Random",_mission] call spawn_static;

//Troops
_rndnum = round (random 5);
[[(_position select 0) - 2, (_position select 1) - 5, 0],5,"Medium",["Random","RPG7V"],3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) - 19, (_position select 1) + 19, 0],5,"Medium",["Random","RPG7V"],3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 17, (_position select 1) + 21, 0],_rndnum,"Random","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
