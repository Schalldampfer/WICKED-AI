...
if (_veh_class in ["ori_vil_lada_2105_rust","ori_originsmod_pickupold","ori_transit","ori_poldek_black","ori_poldek","ori_survivorBus","ori_ZAZ968M","ori_taviander","ori_buchanka","ori_m3","ori_maniac","ori_KaTransp","ori_ScrapRaft","ori_bike_d2","ori_col_truck_tent","ori_col_truck_fuel","ori_gaika","ori_rth_originsmod_bathmobile","ori_ScrapBuggy","ori_submarine","ori_bigRaft"]) then {
