...
local _showMarker = _this select 8;
local _enableMines = _this select 9;
local _completionType = _this select 10;
local _msgwin = (_this select 11) select 1;
local _msglose = (_this select 11) select 2;
