...
ai_cleanup_time		 = 40; // time to clear bodies in minutes. Set to -1 to disable AI cleanup.
...
ai_bandit_behaviour	 = "AWARE"; // behavior of bandit AI
...
ai_add_humanity		 = 40; // amount of humanity gained for killing a bandit AI
...
ai_wep_launchers_AT	 = ["MAAWS","RPG7V","RPG7V"];
...
wai_mission_markers		= ["maze","SEair","aiIsland","NEAF","SWAF"]; // List of DZMS mission markers to check
...
wai_avoid_town			= 20; // avoid spawning missions this close to towns, *** doesn't function with infiSTAR enabled ***
...
wai_mission_fuel		= [10,40]; // fuel inside mission spawned vehicles [min%,max%]
wai_vehicle_damage		= [30,70]; // damages to spawn vehicles with [min%,max%]
